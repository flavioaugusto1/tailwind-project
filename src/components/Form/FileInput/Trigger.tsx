...
export function Trigger() {
  ...
  return (
    <label
      htmlFor={id}
      className={twMerge(
        'group flex flex-1 cursor-pointer flex-col items-center gap-3 rounded-lg border border-zinc-300 px-4 py-4 text-center text-zinc-500 shadow-sm ',
    ...
    >
      <div className="rounded-full border-6 border-zinc-50 bg-zinc-100 p-2 group-hover:border-violet-50 group-hover:bg-violet-100 dark:border-zinc-700 dark:bg-zinc-800 dark:group-hover:border-zinc-600 dark:group-hover:bg-zinc-700">
        <UploadCloud className="h-5 w-5 group-hover:text-violet-700 dark:text-zinc-500 dark:group-hover:text-violet-300" />
      </div>
